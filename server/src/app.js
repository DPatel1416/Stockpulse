  ...
  app.get('/api', (req, res) => {
    res.json({
      ...
      routes: {
        ...
        auth: ['POST /api/auth/register', 'POST /api/auth/login', 'POST /api/auth/validate-email', 'GET /api/auth/verify-email', 'POST /api/auth/resend-verification', 'POST /api/auth/demo', 'GET /api/auth/me'],
